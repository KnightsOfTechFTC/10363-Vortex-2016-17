...
/**
 * Created by mathnerd on 1/31/17.
 */
@Autonomous(name = "10363 Auto on Blue (with Vuforia Line Following)")
public class VuforiaLineFollowingTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (a_ground_alpha() < 5 && opModeIsActive() && runtime.seconds() < 5) {
            ...
            idle();}
        runtime.reset();
        boolean seeswheels=false;
        for(VuforiaTrackable beac : beacons){
            if (Objects.equals(beac.getName(), "Wheels")){seeswheels=true;}
        }
        if (seeswheels){
