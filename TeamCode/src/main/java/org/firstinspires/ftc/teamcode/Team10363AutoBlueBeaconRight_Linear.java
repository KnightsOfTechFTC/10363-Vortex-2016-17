...
@Disabled
public class Team10363AutoBlueBeaconRight_Linear extends LinearOpMode{
...
//        RobII.m_intake_power(-1);
            ...
            switch (v_state) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    if (RobII.a_ground_alpha() == 255) {
                        v_state = 255;
                        break;
                    }  // if the color sensor isn't working, just stop autonomous
